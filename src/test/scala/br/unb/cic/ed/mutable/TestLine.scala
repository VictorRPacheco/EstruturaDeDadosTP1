...
class TestLine extends FlatSpec with Matchers with GivenWhenThen with BeforeAndAfter {

  behavior of "A Stack"

  var stack : br.unb.cic.ed.mutable.LineImpl[Int] = _
  ...
  before {
    stack = new br.unb.cic.ed.mutable.FilaImpl[Int](new ArrayList[Int]())
  }
  */
}
